...
var wheel_array : Array[MeridianWheel] = []
var axles : Array[Axle] = []
var front_axle : Axle
var rear_axle : Axle
var drive_wheels : Array[MeridianWheel] = []
...
class Axle:
	var wheels : Array[MeridianWheel] = []
